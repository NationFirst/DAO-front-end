...
export const SUPPORTED_CHAIN_ID = [
  0xa868, 1,
  // 5, 137, 300, 324, 8453, 80001, 84531, 42161, 421613, 11155111,
] as const;
...
export const GASLESS_SUPPORTED_NETWORKS: SupportedNetworks[] = [
  // 'sepolia'
];
...
export const CHAIN_METADATA: Record<SupportedNetworks, ChainData> = {
  nationsfirst: {
    ...
    logo: '/network_icon.png',
    explorer: 'https://explorer-dev.nationsfirst.io/',
    explorerName: 'Nationsfirst',
    isTestnet: true,
    publicRpc: 'https://api-dev-network.nationsfirst.io/ext/bc/C/rpc',
    gatewayNetwork: '',
    nativeCurrency: {
